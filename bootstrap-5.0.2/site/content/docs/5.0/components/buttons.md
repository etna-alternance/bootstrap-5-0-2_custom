...
{{< example >}}
<button type="button" class="btn btn-primary btn-lg"><i class="bi bi-alarm"></i>
</button>
<button type="button" class="btn btn-secondary btn-lg"><i class="bi bi-alarm"></i>
</button>
{{< /example >}}

{{< example >}}
<button type="button" class="btn btn-primary btn-sm"><i class="bi bi-alarm"></i></button>
<button type="button" class="btn btn-secondary btn-sm"><i class="bi bi-alarm"></i></button>
{{< /example >}}
